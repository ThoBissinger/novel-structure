...
import { defineDayTodosFormElement } from "./classes/elements/DayTodosFormElement";
import { defineAssignDeadlineFormElement } from "./classes/elements/AssignDeadlineFormElement";
import { defineSessionPlanFormElement } from "./classes/elements/SessionPlanFormElement";
import { defineImportPreviewFormElement } from "./classes/elements/ImportPreviewFormElement";
import { defineImportMatchFormElement } from "./classes/elements/ImportMatchFormElement";
import { defineTodoAddFormElement } from "./classes/elements/TodoAddFormElement";
import { defineTodoEditFormElement } from "./classes/elements/TodoEditFormElement";
import { definePendingCandidateRowElement } from "./classes/elements/PendingCandidateRowElement";
import { defineCharacterOverviewFormElement } from "./classes/elements/CharacterOverviewFormElement";
import { defineLocationOverviewFormElement } from "./classes/elements/LocationOverviewFormElement";
import { defineDailyPlannerFormElement } from "./classes/elements/DailyPlannerFormElement";
import { defineThreadEditorFormElement } from "./classes/elements/ThreadEditorFormElement";
import { defineTodoHubShellElement } from "./classes/elements/TodoHubShellElement";
import { defineStructureNodeElement } from "./classes/elements/StructureNodeElement";
import { defineStructureViewElement } from "./classes/elements/StructureViewElement";
import { defineRoadmapChipElement } from "./classes/elements/RoadmapChipElement";
import { defineRoadmapCellElement } from "./classes/elements/RoadmapCellElement";
import { defineRoadmapViewElement } from "./classes/elements/RoadmapViewElement";
import { defineBoardCardElement } from "./classes/elements/BoardCardElement";
import { defineBoardViewElement } from "./classes/elements/BoardViewElement";
import { defineNarrativeChartViewElement } from "./classes/elements/NarrativeChartViewElement";
import { defineWeeklyViewElement } from "./classes/elements/WeeklyViewElement";
import { defineSessionViewElement } from "./classes/elements/SessionViewElement";
import { defineSourceGroupedTodoListElement } from "./classes/elements/SourceGroupedTodoListElement";
...
export default class NovelStructurePlugin extends Plugin {
  ...
  async onload() {
    ...
    defineDayTodosFormElement();
    defineAssignDeadlineFormElement();
    defineSessionPlanFormElement();
    defineImportPreviewFormElement();
    defineImportMatchFormElement();
    defineTodoAddFormElement();
    defineTodoEditFormElement();
    definePendingCandidateRowElement();
    defineCharacterOverviewFormElement();
    defineLocationOverviewFormElement();
    defineDailyPlannerFormElement();
    defineThreadEditorFormElement();
    defineTodoHubShellElement();
    defineStructureNodeElement();
    defineStructureViewElement();
    defineRoadmapChipElement();
    defineRoadmapCellElement();
    defineRoadmapViewElement();
    defineBoardCardElement();
    defineBoardViewElement();
    defineNarrativeChartViewElement();
    defineWeeklyViewElement();
    defineSessionViewElement();
    defineSourceGroupedTodoListElement();
